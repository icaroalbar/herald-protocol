...
Spec bruta: [`/openapi.yaml`](/openapi.yaml) — gerada a partir de
[`gateway/openapi.yaml`](https://github.com/icaroalbar/herald-protocol/blob/main/gateway/openapi.yaml)
no repositório.
